...
- `--input_folder`: Исходная папка с видеофайлами (по умолчанию: "d:/video/sorted")
- `--output_folder`: Папка для сохранения извлеченных кадров (по умолчанию: "d:/video/results")
...
- `--input_dir`: Директория с входными видеофайлами (обязательный)
- `--output_dir`: Директория для сохранения результатов (обязательный)
